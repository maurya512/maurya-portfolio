...
// defining default state for each input field
const Contact = () => {
    ...
    // function to handle the action after submitting the form
    function handleSubmit(e) {
        // ensures that the page doesn't reload when the form is submitted
        e.preventDefault();
        fetch("/", {
            method: "POST",
            headers: { "Content-Type": "application/x-www-form-urlencoded" },
            body: encode({ "form-name": "contact", name, emai, message }),
        })
        ...
        <section id="contact">
            <div className="container px-5 py-10 mx-auto flex sm:flex-nowrap flex-wrap">
                {/* <div className="lg:w-2/3 md:w-1/2 bg-gray-900 rounded-lg overflow-hidden sm:mr-10 p-10 flex items-end justify-start relative">
                    might add map to display location
                </div> */}
                ...
                <form
                    ...
                    <div className="relative mb-4">
                        ...
                        <input
                            ...
                            id="name"
                            name="name"
                            className="w-full bg-gray-800 rounded border-gray-700 focus:border-indigo-500 focus:ring-2-indigo-900 text-base outline-none text-gray-100 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out" />
                    </div>
                    {/* email input */}
                    <div className="relative mb-4">
